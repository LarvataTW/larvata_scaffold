...
<% end -%>
                ...
                %>
                {
                    ...
                    render: function ( data, type, full, meta ) {
                        ...
                        var actions = '<a href="<%= '/admin' if admin? %>/<%= controller_file_path %>/' + id + '?master_show_tab='+ master_show_tab_value +'" class="btn btn-default m-r-5"><span class="glyphicon glyphicon-eye-open"></span></a>';
                        actions += '<a href="<%= '/admin' if admin? %>/<%= controller_file_path %>/' + id + '/edit?master_show_tab='+ master_show_tab_value +'" class="btn btn-default m-r-5"><span class="glyphicon glyphicon-pencil"></span></a>';
            ...
            buttons: [
                { extend: 'create', editor: editor, text: 'New', className: 'btn btn-default datatables_buttons' },
