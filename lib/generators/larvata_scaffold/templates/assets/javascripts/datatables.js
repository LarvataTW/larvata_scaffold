    ...
    <% end -%>
                    ...
                    %>
                    {
                        ...
                        render: function ( data, type, full, meta ) {
                            ...
                            var actions = '<a href="<%= '/admin' if admin? %>/<%= controller_file_path %>/' + id + '?master_show_tab='+ master_show_tab_value +'" class="btn btn-default m-r-10"><span class="fa fa-eye fa-lg"></span></a>';
                            actions += '<a href="<%= '/admin' if admin? %>/<%= controller_file_path %>/' + id + '/edit?master_show_tab='+ master_show_tab_value +'" class="btn btn-default m-r-10"><span class="fa fa-pencil fa-lg"></span></a>';
