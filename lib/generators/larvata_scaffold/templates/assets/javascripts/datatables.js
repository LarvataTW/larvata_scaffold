      ...
      columns:[
        ...
        %>
        {
          ...
          render: function ( data, type, full, meta ) {
            ...
            actions += '<a href="<%= '/admin' if admin? %>/<%= controller_file_path %>/' + id + '" class="btn btn-default deleteButton m-r-5" rel="nofollow"><span class="glyphicon glyphicon-trash"></span></a>';
