...
<% end -%>
            ...
            buttons: [
                ...
                { extend: 'copy', text: 'Copy', exportOptions: { columns: ':visible:not(:last)' }, className: 'btn btn-default datatables_buttons' },
                { extend: 'csv', text: 'CSV', exportOptions: { columns: ':visible:not(:last)' }, className: 'btn btn-default datatables_buttons' },
                { extend: 'excel', text: 'Excel', exportOptions: { columns: ':visible:not(:last)' }, className: 'btn btn-default datatables_buttons' },
                { extend: 'pdf', text: 'PDF', exportOptions: { columns: ':visible:not(:last)' }, className: 'btn btn-default datatables_buttons' },
                { extend: 'print', text: 'Print', exportOptions: { columns: ':visible:not(:last)' }, className: 'btn btn-default datatables_buttons' },
            ],
<% if contains_sorting_column? -%>
            rowReorder: {
                dataSrc: 'sorting'
...
<% end -%>
        ...
        $("#"+ tab_key +"_<%= controller_file_name %>_table").on( 'click', 'tbody td.editable', function (e) {
            editor.inline( datatable.cell(this).index(), {
                onBlur: 'submit'
            } );
        } );
