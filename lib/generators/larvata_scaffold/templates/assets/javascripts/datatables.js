...
<% end -%>
                ...
                %>
                {
                    ...
                    render: function ( data, type, full, meta ) {
                        var id = data.id;
                        var actions = '<a href="<%= '/admin' if admin? %>/<%= controller_file_path %>/' + id + '/edit" class="btn btn-default" style="margin-right:5px"><span class="glyphicon glyphicon-pencil"></span></a>';
